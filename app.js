...
const dotenv = require("dotenv"); //This is what you need to access your secret api key on the .env file within the root directory
dotenv.config(); // YOu initialize dotenv like this
...
//Connect To MongoDB.
const dbURI = process.env.mongoURI // This is how you access the mongoURI from you .env file using process.env.<name_of_key>
